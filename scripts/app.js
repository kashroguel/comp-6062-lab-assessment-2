...
const app = Vue.createApp({
    ...
    data() {
        return {
            myFullName: "Kashina Jian Roguel",
    ...
    methods: {
        isActive(pressureLevel) {
            ...
            return (this.pressureMonitorValue >= this.pressureMonitorLevels.min && this.pressureMonitorValue <= this.pressureMonitorLevels.max); 
        }
    }
});
